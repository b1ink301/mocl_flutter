...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String time,  String viewCount,  String likeCount,  String bodyHtml,  String csrf,  String info,  UserInfo userInfo,  List<CommentItem> comments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Details() when $default != null:
return $default(_that.title,_that.time,_that.viewCount,_that.likeCount,_that.bodyHtml,_that.csrf,_that.info,_that.userInfo,_that.comments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String time,  String viewCount,  String likeCount,  String bodyHtml,  String csrf,  String info,  UserInfo userInfo,  List<CommentItem> comments)  $default,) {final _that = this;
switch (_that) {
case _Details():
return $default(_that.title,_that.time,_that.viewCount,_that.likeCount,_that.bodyHtml,_that.csrf,_that.info,_that.userInfo,_that.comments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String time,  String viewCount,  String likeCount,  String bodyHtml,  String csrf,  String info,  UserInfo userInfo,  List<CommentItem> comments)?  $default,) {final _that = this;
switch (_that) {
case _Details() when $default != null:
return $default(_that.title,_that.time,_that.viewCount,_that.likeCount,_that.bodyHtml,_that.csrf,_that.info,_that.userInfo,_that.comments);case _:
  return null;
