...
class MeecoApi extends BaseApi {
  ...
  Future<Result<List<ListItem>>> list(
    ...
    final Response response = await get(url, headers: headers);
    log(
      '[getList] $url, $headers response = ${response.statusCode}, parser=${parser.runtimeType}',
    );
  ...
  Future<Result<List<ListItem>>> searchList(
    ...
    final Response response = await get(url, headers: headers);
    log(
      '[searchList] $url, $headers response = ${response.statusCode}, parser=${parser.runtimeType}',
    );
