...
class _PageState implements PageState {
  const _PageState({required  List<ListItem> items, required this.isLoading, required this.currentPage, required this.lastId, this.hasReachedMax = false, this.error}): _items = items;
