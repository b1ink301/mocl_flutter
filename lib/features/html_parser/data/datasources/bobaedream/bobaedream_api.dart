...
/// 보배드림 읽기는 비로그인도 가능하지만, 로그인 시 회원 전용/연령 제한 글을
/// 보려면 쿠키가 필요하므로 [getWithCookies] 로 로그인 쿠키를 함께 보낸다.
class BobaedreamApi extends BaseApi {
  const BobaedreamApi(super.dio, super.userAgent);
