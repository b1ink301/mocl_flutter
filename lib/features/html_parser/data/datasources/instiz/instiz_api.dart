...
/// 인스티즈 읽기는 비로그인도 가능하지만, 로그인 시 회원 기능을 위해
/// [getWithCookies] 로 쿠키를 함께 보낸다. 게시판 목록은 asset JSON 사용.
class InstizApi extends BaseApi {
  const InstizApi(super.dio, super.userAgent);
