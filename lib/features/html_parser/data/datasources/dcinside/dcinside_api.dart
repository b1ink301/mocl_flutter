...
/// 디시인사이드 읽기는 비로그인도 가능하지만, 로그인 시 회원/연령 제한 글
/// 열람을 위해 [getWithCookies] 로 로그인 쿠키를 함께 보낸다.
class DcinsideApi extends BaseApi {
  const DcinsideApi(super.dio, super.userAgent);
