...
mixin _$GetVersionState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is GetVersionState);
  }
...
class $GetVersionStateCopyWith<$Res> {
  $GetVersionStateCopyWith(
      GetVersionState _, $Res Function(GetVersionState) __);
}
...
class InitialGetVersionState implements GetVersionState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is InitialGetVersionState);
  }
...
class LoadingGetVersionState implements GetVersionState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LoadingGetVersionState);
  }
...
class SuccessGetVersionState implements GetVersionState {
  ...
  $SuccessGetVersionStateCopyWith<SuccessGetVersionState> get copyWith =>
      _$SuccessGetVersionStateCopyWithImpl<SuccessGetVersionState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SuccessGetVersionState &&
...
/// @nodoc
abstract mixin class $SuccessGetVersionStateCopyWith<$Res>
    implements $GetVersionStateCopyWith<$Res> {
  factory $SuccessGetVersionStateCopyWith(SuccessGetVersionState value,
          $Res Function(SuccessGetVersionState) _then) =
      _$SuccessGetVersionStateCopyWithImpl;
  @useResult
...
class FailureGetVersionState implements GetVersionState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FailureGetVersionStateCopyWith<FailureGetVersionState> get copyWith =>
      _$FailureGetVersionStateCopyWithImpl<FailureGetVersionState>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FailureGetVersionState &&
...
/// @nodoc
abstract mixin class $FailureGetVersionStateCopyWith<$Res>
    implements $GetVersionStateCopyWith<$Res> {
  factory $FailureGetVersionStateCopyWith(FailureGetVersionState value,
          $Res Function(FailureGetVersionState) _then) =
      _$FailureGetVersionStateCopyWithImpl;
  @useResult
